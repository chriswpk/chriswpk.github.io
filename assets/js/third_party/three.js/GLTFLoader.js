    ...
    class GLTFParser {
            ...
            if (!dependency) {
                switch (type) {
                    ...
                    case "bufferView":
                        dependency = this._invokeOne(function (ext) {
                            return (
                                ext.loadBufferView && ext.loadBufferView(index)
                            );
                        });
                        break;
        ...
        loadAccessor(accessorIndex) {
            ...
            return Promise.all(pendingBufferViews).then(function (bufferViews) {
                ...
                const TypedArray =
                    WEBGL_COMPONENT_TYPES[accessorDef.componentType]; // For VEC3: itemSize is 3, elementBytes is 4, itemBytes is 12.
            ...
            .then(function (node) {
                ...
                return parser
                    ...
                    .then(function (skin) {
                        ...
                        for (
                            let i = 0, il = skinEntry.joints.length;
                            i < il;
                            i++
                        ) {
                            pendingJoints.push(
